...
export const BACKOFFICE_ROUTES: RouteInfo[] = [
  ...
  { path: '/backoffice/quiz', title: 'Desafios', icon: 'pe-7s-stopwatch', class: '', roles: ['FREE', 'PREMIUM'] },
  ...
  { path: '/backoffice/courses', title: 'Cursos on-line', icon: 'pe-7s-umbrella', class: '', roles: ['ADMIN'] }
]
@Component({
